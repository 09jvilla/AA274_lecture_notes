...
\end{bmatrix}
\]
This filter is commonly used to reduce noise and smooth or blur an image, as seen in figure \ref{movag}. The \textif{normalization} is done so that the overall brightness of the image remains constant. 
\begin{figure}[h]
  \centering
